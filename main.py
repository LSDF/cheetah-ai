...
async def home(request: Request):
    return templates.TemplateResponse("index.html", {
        ...
        "description": "Free cybersecurity learning platform with ethical hacking challenges, OSINT tools, and study materials."
    })
...
async def about(request: Request):
    return templates.TemplateResponse("about.html", {
        ...
        "description": "Cheetah Cyber is an educational platform for learning ethical hacking, cybersecurity, and OSINT."
    })
